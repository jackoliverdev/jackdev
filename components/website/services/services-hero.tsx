...
import { Globe, Bot, Wrench, Code2, Brain, Laptop, Sparkles, Zap, CheckCircle, ArrowRight, Star, Calendar, Monitor } from 'lucide-react'
...
const services = [
  ...
  },
  {
    icon: Bot,
    title: 'AI Solutions',
    shortDesc: 'Cutting-edge AI integrations',
  ...
  },
  {
    ...
    shortDesc: 'Expert guidance & maintenance',
      ...
      <section className="relative overflow-hidden pt-20 lg:pt-32 pb-16 lg:pb-24">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="hidden lg:block">
            <FloatingElement delay={1} duration={7} amplitude={15}>
              <div className="absolute top-40 right-[15%] p-3 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-xl backdrop-blur-sm border border-purple-500/20">
          ...
          <div className="hidden lg:block">
            <FloatingElement delay={3.5} duration={8} amplitude={18}>
              <div className="absolute top-[28rem] right-[25%] p-3 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-xl backdrop-blur-sm border border-orange-500/20">
          ...
          <div className="hidden lg:block">
            <FloatingElement delay={2.5} duration={9} amplitude={20}>
              <div className="absolute top-[30rem] left-[20%] p-3 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl backdrop-blur-sm border border-blue-500/20">
          ...
          <div className="block lg:hidden">
            <FloatingElement delay={0.5} duration={8} amplitude={10}>
              <div className="absolute top-28 left-5 p-2 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg backdrop-blur-sm border border-purple-500/20">
          ...
          <div className="block lg:hidden">
            <FloatingElement delay={1.0} duration={9} amplitude={8}>
              <div className="absolute top-32 right-5 p-2 bg-gradient-to-br from-orange-600/20 to-red-600/20 rounded-lg backdrop-blur-sm border border-orange-500/20">
        ...
        <div className="container relative mx-auto px-4">
          <div className="text-center">
            ...
            >
              <Sparkles className="mr-2 w-4 h-4 text-blue-500" />
            ...
            >
              <h1 className="text-4xl font-bold tracking-tight lg:text-6xl xl:text-7xl leading-tight lg:leading-tight xl:leading-tight">
                ...
                <div className="text-foreground hidden lg:block">
                  <AnimatedText text="Services That" delay={0.8} charDelay={0.04} />
                </div>
                {/* Mobile */}
                <div className="text-foreground block lg:hidden">
                  <AnimatedText text="Services That" delay={0.8} charDelay={0.06} />
                </div>

                {/* Desktop Second Line */}
                <div className="text-gradient-light-blue hidden lg:block">
                  <AnimatedText text="Absolutely Dominate" delay={1.4} charDelay={0.04} />
                </div>
                {/* Mobile Second Line */}
                <div className="text-gradient-light-blue block lg:hidden">
                  <AnimatedText text="Absolutely Dominate" delay={1.4} charDelay={0.06} />
                </div>
              </h1>
            </motion.div>

            {/* Subheading - Improved timing and 2 lines only */}
            <motion.div
            ...
            >
              ...
              >
                Professional websites, intelligent AI solutions, and expert consulting
                <br />
                that transform your business and outclass the competition.
              </motion.p>
            </motion.div>

            {/* Enhanced CTA Buttons - Same as hero.tsx */}
            <motion.div
