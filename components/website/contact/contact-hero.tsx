...
import { MessageSquare, Calendar, Phone, Mail, Clock, MapPin, Sparkles, Zap, ArrowRight, Star } from 'lucide-react'
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="hidden lg:block">
            <FloatingElement delay={3.5} duration={8} amplitude={18}>
              <div className="absolute top-[28rem] right-[25%] p-3 bg-gradient-to-br from-emerald-500/20 to-green-500/20 rounded-xl backdrop-blur-sm border border-emerald-500/20">
          ...
          <div className="hidden lg:block">
            <FloatingElement delay={5} duration={6} amplitude={15}>
              <div className="absolute top-40 left-[15%] p-3 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl backdrop-blur-sm border border-purple-500/20">
          ...
          <div className="block lg:hidden">
            <FloatingElement delay={1.0} duration={9} amplitude={8}>
              <div className="absolute top-32 right-5 p-2 bg-gradient-to-br from-emerald-600/20 to-green-600/20 rounded-lg backdrop-blur-sm border border-emerald-500/20">
        ...
        <div className="container relative mx-auto px-4">
          <div className="text-center">
            ...
            >
              <h1 className="text-4xl font-bold tracking-tight lg:text-6xl xl:text-7xl leading-tight lg:leading-tight xl:leading-tight">
                ...
                <div className="text-foreground hidden lg:block">
                  <AnimatedText text="Ready to Make" delay={0.8} charDelay={0.04} />
                </div>
                {/* Mobile */}
                <div className="text-foreground block lg:hidden">
                  <AnimatedText text="Ready to Make" delay={0.8} charDelay={0.06} />
                </div>

                {/* Desktop Second Line */}
                <div className="text-gradient-light-blue hidden lg:block">
                  <AnimatedText text="Something Epic?" delay={1.4} charDelay={0.04} />
                </div>
                {/* Mobile Second Line */}
                <div className="text-gradient-light-blue block lg:hidden">
                  <AnimatedText text="Something Epic?" delay={1.4} charDelay={0.06} />
                </div>
              </h1>
            </motion.div>
            ...
            >
              ...
              >
                Drop me a message or book a call - I'm always excited to discuss new projects 
                <br />
                and help turn your brilliant ideas into digital reality.
              </motion.p>
            </motion.div>
